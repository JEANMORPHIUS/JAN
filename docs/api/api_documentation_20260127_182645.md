...
**Version:** 1.0.0  
**Generated:** 2026-01-27T18:26:45.692186
...
8. [POST /api/templates/create](#post-apitemplatescreate) - Create Template
9. [GET /api/templates/list](#get-apitemplateslist) - List Templates
10. [GET /api/templates/{template_name}](#get-apitemplatestemplate_name) - Get Template
11. [DELETE /api/templates/{template_name}](#delete-apitemplatestemplate_name) - Delete Template
12. [POST /api/templates/instantiate](#post-apitemplatesinstantiate) - Instantiate Template
13. [POST /api/templates/save-from-persona](#post-apitemplatessave-from-persona) - Save Persona As Template
14. [GET /api/marketplace/personas](#get-apimarketplacepersonas) - Browse Personas
15. [POST /api/marketplace/personas](#post-apimarketplacepersonas) - Submit Persona
16. [GET /api/marketplace/personas/{persona_id}](#get-apimarketplacepersonaspersona_id) - Get Persona Details
17. [POST /api/marketplace/personas/{persona_id}/download](#post-apimarketplacepersonaspersona_iddownload) - Download Persona
18. [POST /api/marketplace/personas/{persona_id}/rate](#post-apimarketplacepersonaspersona_idrate) - Rate Persona
19. [GET /api/marketplace/categories](#get-apimarketplacecategories) - Get Categories
20. [POST /api/auth/register](#post-apiauthregister) - Register
21. [POST /api/auth/login](#post-apiauthlogin) - Login
22. [POST /api/auth/refresh](#post-apiauthrefresh) - Refresh Token
23. [GET /api/auth/me](#get-apiauthme) - Get Current User Info
24. [POST /api/auth/logout](#post-apiauthlogout) - Logout
25. [GET /api/auth/admin/users](#get-apiauthadminusers) - List Users
26. [PUT /api/auth/admin/users/{user_id}/status](#put-apiauthadminusersuser_idstatus) - Update User Status
27. [POST /api/oracle/cast](#post-apioraclecast) - Cast Oracle
28. [GET /api/oracle/session](#get-apioraclesession) - Get Session
29. [POST /api/oracle/break](#post-apioraclebreak) - Record Break
30. [GET /api/oracle/history](#get-apioraclehistory) - Get Cast History
31. [POST /api/oracle-matrix/audit/{system_type}](#post-apioracle-matrixauditsystem_type) - Audit System
32. [POST /api/oracle-matrix/apply/{system_type}](#post-apioracle-matrixapplysystem_type) - Apply Oracle Matrix
33. [POST /api/oracle-matrix/audit-all](#post-apioracle-matrixaudit-all) - Audit All Systems
34. [GET /api/oracle-matrix/status](#get-apioracle-matrixstatus) - Get Integration Status
35. [GET /api/oracle-matrix/systems](#get-apioracle-matrixsystems) - List Systems
36. [POST /api/oracle-matrix/apply-all](#post-apioracle-matrixapply-all) - Apply To All Systems
37. [POST /api/game-of-racon/cast](#post-apigame-of-raconcast) - Cast Spiritual Oracle
38. [POST /api/game-of-racon/homework/submit](#post-apigame-of-raconhomeworksubmit) - Submit Homework Assignment
39. [GET /api/game-of-racon/homework/pending](#get-apigame-of-raconhomeworkpending) - Get Pending Homework Assignments
40. [GET /api/game-of-racon/session](#get-apigame-of-raconsession) - Get Spiritual Session
41. [POST /api/oracle-gateway/read-cards](#post-apioracle-gatewayread-cards) - Read The Cards
42. [GET /api/oracle-gateway/check-access](#get-apioracle-gatewaycheck-access) - Check Access
43. [GET /api/oracle-gateway/visitor/{visitor_id}](#get-apioracle-gatewayvisitorvisitor_id) - Get Visitor Info
44. [GET /api/oracle-gateway/message](#get-apioracle-gatewaymessage) - Get Gateway Message
45. [POST /api/oracle-universal/cast](#post-apioracle-universalcast) - Cast Universal
46. [GET /api/oracle-universal/principle](#get-apioracle-universalprinciple) - Get Universal Principle
47. [GET /api/heritage/timeline/{dimension}](#get-apiheritagetimelinedimension) - Get Timeline Sites
48. [GET /api/heritage/chronology](#get-apiheritagechronology) - Get Chronology
49. [GET /api/heritage/patterns](#get-apiheritagepatterns) - Get Patterns
50. [GET /api/heritage/site/{site_id}](#get-apiheritagesitesite_id) - Get Site Details
51. [POST /api/heritage/site](#post-apiheritagesite) - Create Heritage Site
52. [GET /api/heritage/search](#get-apiheritagesearch) - Search Heritage
53. [GET /api/heritage/stats](#get-apiheritagestats) - Get Heritage Stats
54. [POST /api/heritage/cleanse](#post-apiheritagecleanse) - Cleanse Narrative
55. [POST /api/heritage/care-package](#post-apiheritagecare-package) - Care Package Cleanse
56. [GET /api/heritage/sanctuary/status](#get-apiheritagesanctuarystatus) - Get Sanctuary Status
57. [GET /api/heritage-meridian/status](#get-apiheritage-meridianstatus) - Get Status
58. [GET /api/heritage-meridian/pillars](#get-apiheritage-meridianpillars) - Get Pillars
59. [GET /api/heritage-meridian/pillars/{pillar_id}](#get-apiheritage-meridianpillarspillar_id) - Get Pillar
60. [GET /api/heritage-meridian/wonders](#get-apiheritage-meridianwonders) - Get Wonders
61. [GET /api/heritage-meridian/wonders/{wonder_id}](#get-apiheritage-meridianwonderswonder_id) - Get Wonder
62. [GET /api/heritage-meridian/meridians](#get-apiheritage-meridianmeridians) - Get Meridians
63. [GET /api/heritage-meridian/network-health](#get-apiheritage-meridiannetwork-health) - Get Network Health
64. [GET /api/heritage-meridian/7-wonders/list](#get-apiheritage-meridian7-wonderslist) - Get 7 Wonders List
65. [GET /api/heritage-meridian/7-wonders/{wonder_id}](#get-apiheritage-meridian7-wonderswonder_id) - Get 7 Wonder
66. [GET /api/heritage-meridian/7-wonders/{wonder_id}/resonance](#get-apiheritage-meridian7-wonderswonder_idresonance) - Get Wonder Resonance
67. [GET /api/heritage-meridian/7-wonders/{wonder_id}/meridian-connections](#get-apiheritage-meridian7-wonderswonder_idmeridian-connections) - Get Wonder Meridian Connections
68. [GET /api/health/templates](#get-apihealthtemplates) - Get Condition Templates
69. [POST /api/health/condition](#post-apihealthcondition) - Register Condition
70. [POST /api/health/log](#post-apihealthlog) - Log Health Entry
71. [GET /api/health/summary](#get-apihealthsummary) - Get Health Summary
72. [GET /api/health/export](#get-apihealthexport) - Export Health Data
73. [GET /api/health/status](#get-apihealthstatus) - Health Api Status
74. [GET /api/educational/overview](#get-apieducationaloverview) - Get Educational Overview
75. [GET /api/educational/system/{system_name}](#get-apieducationalsystemsystem_name) - Get System Education
76. [GET /api/educational/connections](#get-apieducationalconnections) - Get System Connections
77. [GET /api/educational/learn/{topic}](#get-apieducationallearntopic) - Get Learning Topic
78. [POST /api/raspberry-pi/build](#post-apiraspberry-pibuild) - Build Package
79. [GET /api/raspberry-pi/deployments](#get-apiraspberry-pideployments) - List Deployments
80. [GET /api/raspberry-pi/deployments/{deployment_id}](#get-apiraspberry-pideploymentsdeployment_id) - Get Deployment
81. [GET /api/raspberry-pi/deployments/{deployment_id}/info](#get-apiraspberry-pideploymentsdeployment_idinfo) - Get Package Info
82. [GET /api/raspberry-pi/health](#get-apiraspberry-pihealth) - Deployment Health
83. [POST /api/education-professional/schools/register](#post-apieducation-professionalschoolsregister) - Register School
84. [POST /api/education-professional/schools/{school_id}/deploy](#post-apieducation-professionalschoolsschool_iddeploy) - Deploy To School
85. [GET /api/education-professional/schools](#get-apieducation-professionalschools) - List Schools
86. [GET /api/education-professional/schools/{school_id}](#get-apieducation-professionalschoolsschool_id) - Get School
87. [GET /api/education-professional/analytics](#get-apieducation-professionalanalytics) - Get Analytics
88. [GET /api/education-professional/health](#get-apieducation-professionalhealth) - Deployment Health
89. [GET /api/deployment-dashboard/overview](#get-apideployment-dashboardoverview) - Get Dashboard Overview
90. [GET /api/deployment-dashboard/analytics](#get-apideployment-dashboardanalytics) - Get Deployment Analytics
91. [GET /api/deployment-dashboard/health](#get-apideployment-dashboardhealth) - Get Deployment Health
92. [GET /api/school-curriculum/lessons](#get-apischool-curriculumlessons) - Get Lessons
93. [GET /api/school-curriculum/modules](#get-apischool-curriculummodules) - Get Modules
94. [POST /api/school-curriculum/curricula](#post-apischool-curriculumcurricula) - Create Curriculum
95. [GET /api/school-curriculum/curricula](#get-apischool-curriculumcurricula) - List Curricula
96. [GET /api/school-curriculum/curricula/{curriculum_id}](#get-apischool-curriculumcurriculacurriculum_id) - Get Curriculum
97. [POST /api/school-curriculum/progress](#post-apischool-curriculumprogress) - Update Progress
98. [GET /api/school-curriculum/progress/{student_id}](#get-apischool-curriculumprogressstudent_id) - Get Student Progress
99. [GET /api/school-curriculum/curricula/{curriculum_id}/analytics](#get-apischool-curriculumcurriculacurriculum_idanalytics) - Get Curriculum Analytics
100. [GET /api/school-curriculum/stats](#get-apischool-curriculumstats) - Get Curriculum Stats
101. [GET /api/system-integration/status](#get-apisystem-integrationstatus) - Get Integration Status
102. [GET /api/system-integration/systems](#get-apisystem-integrationsystems) - List Systems
103. [GET /api/system-integration/systems/{system_id}](#get-apisystem-integrationsystemssystem_id) - Get System
104. [GET /api/system-integration/alignment-map](#get-apisystem-integrationalignment-map) - Get Alignment Map
105. [GET /api/system-integration/curriculum/integration](#get-apisystem-integrationcurriculumintegration) - Verify Curriculum Integration
106. [GET /api/system-integration/health](#get-apisystem-integrationhealth) - Get Integration Health
107. [GET /api/ramiz-humanitarian/gaza/priority](#get-apiramiz-humanitariangazapriority) - Get Gaza Priority
108. [GET /api/ramiz-humanitarian/needs](#get-apiramiz-humanitarianneeds) - List Needs
109. [POST /api/ramiz-humanitarian/needs/register](#post-apiramiz-humanitarianneedsregister) - Register Need
110. [GET /api/ramiz-humanitarian/projects](#get-apiramiz-humanitarianprojects) - List Projects
111. [POST /api/ramiz-humanitarian/projects/create](#post-apiramiz-humanitarianprojectscreate) - Create Project
112. [POST /api/ramiz-humanitarian/aid/deliver](#post-apiramiz-humanitarianaiddeliver) - Deliver Aid
113. [GET /api/ramiz-humanitarian/analytics](#get-apiramiz-humanitariananalytics) - Get Analytics
114. [POST /api/ramiz-humanitarian/projects/{project_id}/integrate/curriculum](#post-apiramiz-humanitarianprojectsproject_idintegratecurriculum) - Integrate With Curriculum
115. [POST /api/ramiz-humanitarian/projects/{project_id}/integrate/raspberry-pi](#post-apiramiz-humanitarianprojectsproject_idintegrateraspberry-pi) - Integrate With Raspberry Pi
116. [GET /api/ramiz-humanitarian/health](#get-apiramiz-humanitarianhealth) - Get Humanitarian Health
117. [GET /api/ramiz-humanitarian/comprehensive-status](#get-apiramiz-humanitariancomprehensive-status) - Get Comprehensive Status
118. [POST /api/ramiz-humanitarian/funding/record](#post-apiramiz-humanitarianfundingrecord) - Record Funding
119. [POST /api/ramiz-humanitarian/funding/integrate-dirty-money](#post-apiramiz-humanitarianfundingintegrate-dirty-money) - Integrate Dirty Money
120. [GET /api/ramiz-humanitarian/funding/gaza/status](#get-apiramiz-humanitarianfundinggazastatus) - Get Gaza Funding Status
121. [GET /api/ramiz-humanitarian/funding/analytics](#get-apiramiz-humanitarianfundinganalytics) - Get Funding Analytics
122. [POST /api/ramiz-humanitarian/volunteers/register](#post-apiramiz-humanitarianvolunteersregister) - Register Volunteer
123. [POST /api/ramiz-humanitarian/volunteers/deploy](#post-apiramiz-humanitarianvolunteersdeploy) - Deploy Volunteer
124. [GET /api/ramiz-humanitarian/volunteers/gaza](#get-apiramiz-humanitarianvolunteersgaza) - Get Gaza Volunteers
125. [GET /api/ramiz-humanitarian/volunteers/analytics](#get-apiramiz-humanitarianvolunteersanalytics) - Get Volunteer Analytics
126. [POST /api/ramiz-humanitarian/supply-chain/orders/create](#post-apiramiz-humanitariansupply-chainorderscreate) - Create Order
127. [POST /api/ramiz-humanitarian/supply-chain/deliveries/track](#post-apiramiz-humanitariansupply-chaindeliveriestrack) - Track Delivery
128. [POST /api/ramiz-humanitarian/supply-chain/orders/{order_id}/received](#post-apiramiz-humanitariansupply-chainordersorder_idreceived) - Mark Received
129. [POST /api/ramiz-humanitarian/supply-chain/orders/{order_id}/distributed](#post-apiramiz-humanitariansupply-chainordersorder_iddistributed) - Mark Distributed
130. [GET /api/ramiz-humanitarian/supply-chain/gaza/status](#get-apiramiz-humanitariansupply-chaingazastatus) - Get Gaza Supply Status
131. [GET /api/ramiz-humanitarian/supply-chain/analytics](#get-apiramiz-humanitariansupply-chainanalytics) - Get Supply Analytics
132. [POST /api/ramiz-humanitarian/communications/send](#post-apiramiz-humanitariancommunicationssend) - Send Communication
133. [POST /api/ramiz-humanitarian/communications/gaza/alert](#post-apiramiz-humanitariancommunicationsgazaalert) - Send Gaza Alert
134. [GET /api/ramiz-humanitarian/communications/gaza](#get-apiramiz-humanitariancommunicationsgaza) - Get Gaza Communications
135. [GET /api/ramiz-humanitarian/communications/analytics](#get-apiramiz-humanitariancommunicationsanalytics) - Get Communications Analytics
136. [GET /api/universal-expansion/plan](#get-apiuniversal-expansionplan) - Get Expansion Plan
137. [GET /api/universal-expansion/targets](#get-apiuniversal-expansiontargets) - List Targets
138. [POST /api/universal-expansion/targets/{target_id}/expand](#post-apiuniversal-expansiontargetstarget_idexpand) - Expand Target
139. [GET /api/universal-expansion/targets/{target_id}](#get-apiuniversal-expansiontargetstarget_id) - Get Target
140. [GET /api/universal-expansion/analytics](#get-apiuniversal-expansionanalytics) - Get Expansion Analytics
141. [GET /api/universal-expansion/health](#get-apiuniversal-expansionhealth) - Get Expansion Health
142. [GET /api/knowledge/sources](#get-apiknowledgesources) - Get Sources
143. [GET /api/knowledge/summary](#get-apiknowledgesummary) - Get Summary
144. [GET /api/knowledge/all](#get-apiknowledgeall) - Get All
145. [POST /api/knowledge/register](#post-apiknowledgeregister) - Register Knowledge
146. [POST /api/connection-ritual](#post-apiconnection-ritual) - Connection Ritual Endpoint
147. [POST /api/check-battle-compatibility](#post-apicheck-battle-compatibility) - Check Battle Compatibility Endpoint
148. [GET /api/vibration-map](#get-apivibration-map) - Get Vibration Map
149. [GET /api/energy-alerts](#get-apienergy-alerts) - Get Energy Alerts
150. [GET /api/sentinel/status](#get-apisentinelstatus) - Get Sentinel Status
151. [POST /api/sentinel/start](#post-apisentinelstart) - Start Sentinel
152. [POST /api/sentinel/stop](#post-apisentinelstop) - Stop Sentinel
153. [GET /api/sentinel/alerts](#get-apisentinelalerts) - Get Sentinel Alerts
154. [GET /api/morning-summary](#get-apimorning-summary) - Get Morning Summary
155. [GET /api/care-package/](#get-apicare-package) - Get Care Package
156. [GET /api/care-package/system-diagnostics](#get-apicare-packagesystem-diagnostics) - Get System Diagnostics
157. [POST /api/care-package/political-alignment](#post-apicare-packagepolitical-alignment) - Check Political Alignment
158. [POST /api/care-package/economic-alignment](#post-apicare-packageeconomic-alignment) - Check Economic Alignment
159. [POST /api/care-package/complete-alignment](#post-apicare-packagecomplete-alignment) - Get Complete Alignment
160. [GET /api/care-package/docs/spirit-alignment](#get-apicare-packagedocsspirit-alignment) - Get Spirit Alignment Docs
161. [GET /api/care-package/docs/political-alignment](#get-apicare-packagedocspolitical-alignment) - Get Political Alignment Docs
162. [GET /api/care-package/docs/economic-alignment](#get-apicare-packagedocseconomic-alignment) - Get Economic Alignment Docs
163. [GET /api/care-package/welfare-systems](#get-apicare-packagewelfare-systems) - Get Welfare Systems Analysis
164. [GET /api/care-package/assessment-guidance](#get-apicare-packageassessment-guidance) - Get Assessment Guidance
165. [GET /api/care-package/welfare-systems/breaking-opportunities](#get-apicare-packagewelfare-systemsbreaking-opportunities) - Get Breaking Opportunities
166. [GET /api/care-package/political-figures](#get-apicare-packagepolitical-figures) - Get Political Figures
167. [GET /api/care-package/political-figures/anchors](#get-apicare-packagepolitical-figuresanchors) - Get Political Anchors
168. [GET /api/care-package/political-figures/by-country](#get-apicare-packagepolitical-figuresby-country) - Get Political Figures By Country
169. [GET /api/care-package/influential-figures](#get-apicare-packageinfluential-figures) - Get Influential Figures
170. [GET /api/care-package/influential-figures/anchors](#get-apicare-packageinfluential-figuresanchors) - Get Influential Anchors
171. [GET /api/care-package/influential-figures/by-domain](#get-apicare-packageinfluential-figuresby-domain) - Get Influential Figures By Domain
172. [GET /api/care-package/one-truth](#get-apicare-packageone-truth) - Get One Truth
173. [GET /api/care-package/timeline-deep-search](#get-apicare-packagetimeline-deep-search) - Get Timeline Deep Search
174. [GET /api/care-package/future-writing](#get-apicare-packagefuture-writing) - Get Future Writing
175. [GET /api/care-package/timeline-future-report](#get-apicare-packagetimeline-future-report) - Get Timeline Future Report
176. [GET /api/care-package/return-to-table-damage](#get-apicare-packagereturn-to-table-damage) - Get Return To Table Damage
177. [GET /api/care-package/return-to-table-damage/assessment](#get-apicare-packagereturn-to-table-damageassessment) - Get Return To Table Damage Assessment
178. [GET /api/care-package/frequential-arts-crafts](#get-apicare-packagefrequential-arts-crafts) - Get Frequential Arts Crafts
179. [GET /api/care-package/frequential-arts-crafts/timeline](#get-apicare-packagefrequential-arts-craftstimeline) - Get Frequential Arts Crafts Timeline
180. [GET /api/care-package/frequential-songs](#get-apicare-packagefrequential-songs) - Get Frequential Songs
181. [GET /api/care-package/frequential-songs/by-language](#get-apicare-packagefrequential-songsby-language) - Get Frequential Songs By Language
182. [GET /api/care-package/spiritual-contracts-miracles](#get-apicare-packagespiritual-contracts-miracles) - Get Spiritual Contracts Miracles
183. [GET /api/care-package/influential-figures/by-country](#get-apicare-packageinfluential-figuresby-country) - Get Influential Figures By Country
184. [POST /api/dirty-money-cleaning/identify](#post-apidirty-money-cleaningidentify) - Identify Dirty Money
185. [POST /api/dirty-money-cleaning/clean/{transaction_id}](#post-apidirty-money-cleaningcleantransaction_id) - Clean Spiritual Contract
186. [POST /api/dirty-money-cleaning/repurpose/{transaction_id}](#post-apidirty-money-cleaningrepurposetransaction_id) - Repurpose For Humanitarian Cause
187. [POST /api/dirty-money-cleaning/complete/{transaction_id}](#post-apidirty-money-cleaningcompletetransaction_id) - Complete Cycle
188. [GET /api/dirty-money-cleaning/summary](#get-apidirty-money-cleaningsummary) - Get System Summary
189. [GET /api/dirty-money-cleaning/transactions](#get-apidirty-money-cleaningtransactions) - Get Transactions
190. [GET /api/dirty-money-cleaning/projects](#get-apidirty-money-cleaningprojects) - Get Projects
191. [GET /api/channel-collaboration/present-purpose](#get-apichannel-collaborationpresent-purpose) - Check Present Purpose Collaboration
192. [GET /api/channel-collaboration/check](#get-apichannel-collaborationcheck) - Check Channel Collaboration
193. [GET /api/channel-collaboration/all](#get-apichannel-collaborationall) - Check All Collaborations
194. [GET /api/channel-collaboration/channel/{channel_type}](#get-apichannel-collaborationchannelchannel_type) - Get Channel Info
195. [GET /api/channel-collaboration/summary](#get-apichannel-collaborationsummary) - Get System Summary
196. [GET /api/channel-collaboration/channels](#get-apichannel-collaborationchannels) - List All Channels
197. [GET /api/spiritual-contracts/all](#get-apispiritual-contractsall) - Get All Contracts
198. [GET /api/spiritual-contracts/summary](#get-apispiritual-contractssummary) - Get Contracts Summary
199. [GET /api/spiritual-contracts/network/{contract_id}](#get-apispiritual-contractsnetworkcontract_id) - Get Contract Network
200. [POST /api/spiritual-contracts/register](#post-apispiritual-contractsregister) - Register Contract
201. [POST /api/spiritual-contracts/link](#post-apispiritual-contractslink) - Link Contracts
202. [POST /api/spiritual-contracts/clean/{contract_id}](#post-apispiritual-contractscleancontract_id) - Clean Contract
203. [POST /api/spiritual-contracts/integrate/dirty-money](#post-apispiritual-contractsintegratedirty-money) - Integrate Dirty Money Contract
204. [POST /api/spiritual-contracts/integrate/spirit-alignment](#post-apispiritual-contractsintegratespirit-alignment) - Integrate Spirit Alignment Contract
205. [POST /api/spiritual-contracts/integrate/dream-battle](#post-apispiritual-contractsintegratedream-battle) - Integrate Dream Battle
206. [POST /api/spiritual-contracts/integrate/daily-battle](#post-apispiritual-contractsintegratedaily-battle) - Integrate Daily Battle
207. [POST /api/doctor-protocol/insulin-protocol](#post-apidoctor-protocolinsulin-protocol) - Create Insulin Protocol
208. [POST /api/doctor-protocol/carb-protocol](#post-apidoctor-protocolcarb-protocol) - Create Carb Counting Protocol
209. [POST /api/doctor-protocol/calculate-insulin](#post-apidoctor-protocolcalculate-insulin) - Calculate Insulin Dose
210. [GET /api/doctor-protocol/active-protocols](#get-apidoctor-protocolactive-protocols) - Get Active Protocols
211. [GET /api/doctor-protocol/summary](#get-apidoctor-protocolsummary) - Get System Summary
212. [POST /api/doctor-protocol/sync](#post-apidoctor-protocolsync) - Sync Protocols
213. [GET /api/doctor-protocol/educational-resources](#get-apidoctor-protocoleducational-resources) - Get Educational Resources
214. [GET /api/judicial-system/judgment-question](#get-apijudicial-systemjudgment-question) - Explore Judgment Question
215. [GET /api/judicial-system/analyze](#get-apijudicial-systemanalyze) - Analyze Judicial System
216. [GET /api/judicial-system/find-truth](#get-apijudicial-systemfind-truth) - Find Truth In Broken Systems
217. [GET /api/judicial-system/navigation-strategy](#get-apijudicial-systemnavigation-strategy) - Get Navigation Strategy
218. [POST /mirror/reflect](#post-mirrorreflect) - Create Mirror Reflection
219. [GET /mirror/user/{user_id}](#get-mirroruseruser_id) - Get User Reflections
220. [POST /council/create](#post-councilcreate) - Create Community Council
221. [POST /council/{council_id}/truth-circle](#post-councilcouncil_idtruth-circle) - Hold Truth Circle
222. [POST /restoration/contract](#post-restorationcontract) - Create Restoration Contract
223. [PATCH /restoration/contract/{contract_id}/progress](#patch-restorationcontractcontract_idprogress) - Update Restoration Progress
224. [GET /restoration/contract/{contract_id}](#get-restorationcontractcontract_id) - Get Restoration Contract
225. [POST /system/replacement](#post-systemreplacement) - Track System Replacement
226. [GET /system/replacement/global](#get-systemreplacementglobal) - Get Global Replacement Status
227. [GET /wisdom/accountability](#get-wisdomaccountability) - Get Accountability Wisdom
228. [GET /wisdom/mirror](#get-wisdommirror) - Get Mirror Wisdom
229. [GET /integration/one-truth](#get-integrationone-truth) - Get One Truth Integration
230. [GET /health](#get-health) - Health
231. [POST /api/spiritual-codebase-hacker/hack-loop](#post-apispiritual-codebase-hackerhack-loop) - Hack Loop Endpoint
232. [POST /api/spiritual-codebase-hacker/genetic-edit](#post-apispiritual-codebase-hackergenetic-edit) - Genetic Edit Endpoint
233. [POST /api/spiritual-codebase-hacker/wipe-hard-drive](#post-apispiritual-codebase-hackerwipe-hard-drive) - Wipe Hard Drive Endpoint
234. [POST /api/spiritual-codebase-hacker/stealth-mode](#post-apispiritual-codebase-hackerstealth-mode) - Stealth Mode Endpoint
235. [POST /api/spiritual-codebase-hacker/starve-parasite](#post-apispiritual-codebase-hackerstarve-parasite) - Starve Parasite Endpoint
236. [POST /api/spiritual-codebase-hacker/upgrade-identity](#post-apispiritual-codebase-hackerupgrade-identity) - Upgrade Identity Endpoint
237. [POST /api/spiritual-codebase-hacker/seal-portal](#post-apispiritual-codebase-hackerseal-portal) - Seal Portal Endpoint
238. [GET /api/spiritual-codebase-hacker/status](#get-apispiritual-codebase-hackerstatus) - Hacker Status
239. [GET /api/ottoman-timeline/timeline](#get-apiottoman-timelinetimeline) - Get Ottoman Timeline
240. [GET /api/ottoman-timeline/generation/{generation_number}](#get-apiottoman-timelinegenerationgeneration_number) - Get Generation
241. [GET /api/ottoman-timeline/cyprus-connection](#get-apiottoman-timelinecyprus-connection) - Get Cyprus Connection
242. [GET /api/ottoman-timeline/report](#get-apiottoman-timelinereport) - Get Timeline Report
243. [GET /api/ottoman-timeline/your-generation](#get-apiottoman-timelineyour-generation) - Get Your Generation
244. [GET /api/superpower-debunking/debunking](#get-apisuperpower-debunkingdebunking) - Get Debunking
245. [GET /api/superpower-debunking/current-superpowers](#get-apisuperpower-debunkingcurrent-superpowers) - Get Current Superpowers
246. [GET /api/superpower-debunking/fathers-hand](#get-apisuperpower-debunkingfathers-hand) - Get Fathers Hand
247. [GET /api/superpower-debunking/comparison](#get-apisuperpower-debunkingcomparison) - Get Comparison
248. [GET /api/african-turkish-yin-yang/symbiosis-map](#get-apiafrican-turkish-yin-yangsymbiosis-map) - Get Symbiosis Map
249. [GET /api/african-turkish-yin-yang/african-yin](#get-apiafrican-turkish-yin-yangafrican-yin) - Get African Yin
250. [GET /api/african-turkish-yin-yang/turkish-yang](#get-apiafrican-turkish-yin-yangturkish-yang) - Get Turkish Yang
251. [GET /api/african-turkish-yin-yang/how-they-sync](#get-apiafrican-turkish-yin-yanghow-they-sync) - Get How They Sync
252. [GET /api/african-turkish-yin-yang/london-communities](#get-apiafrican-turkish-yin-yanglondon-communities) - Get London Communities
253. [POST /api/legal/prs/register](#post-apilegalprsregister) - Register Prs Copyright
254. [GET /api/legal/prs/records](#get-apilegalprsrecords) - Get Prs Records
255. [POST /api/legal/agreements/create](#post-apilegalagreementscreate) - Create Agreement
256. [GET /api/legal/agreements](#get-apilegalagreements) - Get Agreements
257. [GET /api/legal/compliance/verify](#get-apilegalcomplianceverify) - Verify Compliance
258. [GET /api/legal/summary](#get-apilegalsummary) - Get Summary
259. [GET /api/entrepreneurial/blueprints](#get-apientrepreneurialblueprints) - Get All Blueprints
260. [GET /api/entrepreneurial/blueprints/{entity_id}](#get-apientrepreneurialblueprintsentity_id) - Get Blueprint
261. [GET /api/entrepreneurial/the-ark](#get-apientrepreneurialthe-ark) - Get The Ark Blueprint
262. [GET /api/entrepreneurial/documentation/status](#get-apientrepreneurialdocumentationstatus) - Get Documentation Status
263. [GET /api/entrepreneurial/documentation/checklist](#get-apientrepreneurialdocumentationchecklist) - Get Documentation Checklist
264. [POST /api/entrepreneurial/documents/create](#post-apientrepreneurialdocumentscreate) - Create Document
265. [GET /api/language-of-god/the-answer](#get-apilanguage-of-godthe-answer) - Get The Answer
266. [GET /api/language-of-god/historical-languages](#get-apilanguage-of-godhistorical-languages) - Get Historical Languages
267. [GET /api/language-of-god/divine-languages](#get-apilanguage-of-goddivine-languages) - Get Divine Languages
268. [GET /api/language-of-god/sound-is-everything](#get-apilanguage-of-godsound-is-everything) - Get Sound Is Everything
269. [GET /api/language-of-god/complete-map](#get-apilanguage-of-godcomplete-map) - Get Complete Map
270. [GET /api/whales-calling-jan/the-call](#get-apiwhales-calling-janthe-call) - Get The Call
271. [GET /api/whales-calling-jan/whale-calls](#get-apiwhales-calling-janwhale-calls) - Get Whale Calls
272. [GET /api/whales-calling-jan/what-jan-must-do](#get-apiwhales-calling-janwhat-jan-must-do) - Get What Jan Must Do
273. [GET /api/whales-calling-jan/connection-to-sound](#get-apiwhales-calling-janconnection-to-sound) - Get Connection To Sound
274. [GET /api/whales-calling-jan/complete-map](#get-apiwhales-calling-jancomplete-map) - Get Complete Map
275. [GET /api/water-holds-memory/the-truth](#get-apiwater-holds-memorythe-truth) - Get The Truth
276. [GET /api/water-holds-memory/water-memories](#get-apiwater-holds-memorywater-memories) - Get Water Memories
277. [GET /api/water-holds-memory/connection-to-whales](#get-apiwater-holds-memoryconnection-to-whales) - Get Connection To Whales
278. [GET /api/water-holds-memory/connection-to-table](#get-apiwater-holds-memoryconnection-to-table) - Get Connection To Table
279. [GET /api/water-holds-memory/connection-to-sound](#get-apiwater-holds-memoryconnection-to-sound) - Get Connection To Sound
280. [GET /api/water-holds-memory/complete-map](#get-apiwater-holds-memorycomplete-map) - Get Complete Map
281. [GET /api/codebase-philosophy/the-philosophy](#get-apicodebase-philosophythe-philosophy) - Get The Philosophy
282. [GET /api/codebase-philosophy/protocols](#get-apicodebase-philosophyprotocols) - Get Protocols
283. [GET /api/codebase-philosophy/grave-clothes-protocol](#get-apicodebase-philosophygrave-clothes-protocol) - Get Grave Clothes Protocol
284. [GET /api/codebase-philosophy/trojan-horse-strategy](#get-apicodebase-philosophytrojan-horse-strategy) - Get Trojan Horse Strategy
285. [GET /api/codebase-philosophy/connection-to-table](#get-apicodebase-philosophyconnection-to-table) - Get Connection To Table
286. [GET /api/codebase-philosophy/connection-to-original-name](#get-apicodebase-philosophyconnection-to-original-name) - Get Connection To Original Name
287. [GET /api/codebase-philosophy/complete-map](#get-apicodebase-philosophycomplete-map) - Get Complete Map
288. [GET /api/publishing-house/](#get-apipublishing-house) - Get Publishing House Overview
289. [GET /api/publishing-house/channels](#get-apipublishing-housechannels) - Get All Channels
290. [GET /api/publishing-house/channels/{channel_id}](#get-apipublishing-housechannelschannel_id) - Get Channel
291. [GET /api/publishing-house/entities](#get-apipublishing-houseentities) - Get All Entities
292. [GET /api/publishing-house/entities/{entity_id}](#get-apipublishing-houseentitiesentity_id) - Get Entity
293. [GET /api/publishing-house/projects](#get-apipublishing-houseprojects) - Get All Projects
294. [GET /api/publishing-house/projects/{project_id}](#get-apipublishing-houseprojectsproject_id) - Get Project
295. [GET /api/publishing-house/workflows](#get-apipublishing-houseworkflows) - Get Workflows
296. [GET /api/publishing-house/monetization](#get-apipublishing-housemonetization) - Get Monetization
297. [GET /api/publishing-house/expansion](#get-apipublishing-houseexpansion) - Get Expansion Seeds
298. [GET /api/publishing-house/alignment](#get-apipublishing-housealignment) - Get Alignment Summary
299. [GET /api/publishing-house/stats](#get-apipublishing-housestats) - Get Publishing House Stats
300. [POST /healing/journey/start](#post-healingjourneystart) - Start Healing Journey
301. [PATCH /healing/journey/{journey_id}/progress](#patch-healingjourneyjourney_idprogress) - Update Healing Progress
302. [GET /healing/journey/{journey_id}](#get-healingjourneyjourney_id) - Get Healing Journey
303. [GET /healing/journeys/person/{person_id}](#get-healingjourneyspersonperson_id) - Get Person Healing Journeys
304. [POST /healing/practice/log](#post-healingpracticelog) - Log Healing Practice
305. [GET /healing/practice/person/{person_id}/streak](#get-healingpracticepersonperson_idstreak) - Get Healing Streak
306. [POST /healing/community/project](#post-healingcommunityproject) - Create Community Healing Project
307. [GET /healing/community/projects](#get-healingcommunityprojects) - Get All Community Projects
308. [POST /healing/system/replacement](#post-healingsystemreplacement) - Track System Replacement
309. [GET /healing/system/replacement/global](#get-healingsystemreplacementglobal) - Get Global System Replacement
310. [GET /healing/wisdom/{domain}](#get-healingwisdomdomain) - Get Healing Wisdom
311. [GET /healing/universal-laws](#get-healinguniversal-laws) - Get Universal Healing Laws
312. [POST /utilities/debt/forgive](#post-utilitiesdebtforgive) - Forgive Utility Debt
313. [GET /utilities/debt/forgiveness/total](#get-utilitiesdebtforgivenesstotal) - Get Total Debt Forgiveness
314. [POST /utilities/ube/create](#post-utilitiesubecreate) - Create Ube Account
315. [POST /utilities/ube/{ube_id}/log-usage](#post-utilitiesubeube_idlog-usage) - Log Ube Usage
316. [GET /utilities/ube/stats](#get-utilitiesubestats) - Get Ube Statistics
317. [POST /utilities/commons/create](#post-utilitiescommonscreate) - Create Energy Commons
318. [POST /utilities/commons/{commons_id}/production](#post-utilitiescommonscommons_idproduction) - Log Commons Production
319. [GET /utilities/commons/all](#get-utilitiescommonsall) - Get All Energy Commons
320. [POST /utilities/pilot/create](#post-utilitiespilotcreate) - Create Pilot Program
321. [PATCH /utilities/pilot/{pilot_id}/update](#patch-utilitiespilotpilot_idupdate) - Update Pilot Program
322. [GET /utilities/pilot/all](#get-utilitiespilotall) - Get All Pilots
323. [POST /utilities/transition/track](#post-utilitiestransitiontrack) - Track System Transition
324. [GET /utilities/transition/global](#get-utilitiestransitionglobal) - Get Global Transition Status
325. [GET /utilities/wisdom/why-free](#get-utilitieswisdomwhy-free) - Get Why Utilities Should Be Free
326. [GET /api/cloud-seeding/](#get-apicloud-seeding) - Get Cloud Seeding Overview
327. [GET /api/cloud-seeding/claims](#get-apicloud-seedingclaims) - Get All Claims
328. [GET /api/cloud-seeding/claims/{claim_id}](#get-apicloud-seedingclaimsclaim_id) - Get Claim
329. [GET /api/cloud-seeding/operations](#get-apicloud-seedingoperations) - Get All Operations
330. [GET /api/cloud-seeding/operations/weaponized](#get-apicloud-seedingoperationsweaponized) - Get Weaponized Operations
331. [GET /api/cloud-seeding/operations/{operation_id}](#get-apicloud-seedingoperationsoperation_id) - Get Operation
332. [GET /api/cloud-seeding/utilizations](#get-apicloud-seedingutilizations) - Get All Utilizations
333. [GET /api/cloud-seeding/utilizations/{country}](#get-apicloud-seedingutilizationscountry) - Get Utilization
334. [GET /api/cloud-seeding/healing-pathway](#get-apicloud-seedinghealing-pathway) - Get Healing Pathway
335. [GET /api/cloud-seeding/analysis/complete](#get-apicloud-seedinganalysiscomplete) - Get Complete Analysis
336. [POST /api/cloud-seeding/analysis/save](#post-apicloud-seedinganalysissave) - Save Analysis
337. [GET /api/cloud-seeding/health](#get-apicloud-seedinghealth) - Health Check
338. [GET /api/weaponization/](#get-apiweaponization) - Get Weaponization Overview
339. [GET /api/weaponization/events](#get-apiweaponizationevents) - Get All Events
340. [GET /api/weaponization/events/{event_id}](#get-apiweaponizationeventsevent_id) - Get Event
341. [GET /api/weaponization/events/type/{weaponization_type}](#get-apiweaponizationeventstypeweaponization_type) - Get Events By Type
342. [GET /api/weaponization/events/pattern/{pattern}](#get-apiweaponizationeventspatternpattern) - Get Events By Pattern
343. [GET /api/weaponization/patterns](#get-apiweaponizationpatterns) - Get All Patterns
344. [GET /api/weaponization/patterns/{pattern_id}](#get-apiweaponizationpatternspattern_id) - Get Pattern
345. [GET /api/weaponization/analysis/complete](#get-apiweaponizationanalysiscomplete) - Get Complete Analysis
346. [POST /api/weaponization/analysis/save](#post-apiweaponizationanalysissave) - Save Analysis
347. [GET /api/weaponization/health](#get-apiweaponizationhealth) - Health Check
348. [GET /api/peace-weaponization/](#get-apipeace-weaponization) - Get Peace Weaponization Overview
349. [GET /api/peace-weaponization/manifestations](#get-apipeace-weaponizationmanifestations) - Get All Manifestations
350. [GET /api/peace-weaponization/manifestations/{manifestation_id}](#get-apipeace-weaponizationmanifestationsmanifestation_id) - Get Manifestation
351. [GET /api/peace-weaponization/manifestations/strategy/{strategy}](#get-apipeace-weaponizationmanifestationsstrategystrategy) - Get Manifestations By Strategy
352. [GET /api/peace-weaponization/events](#get-apipeace-weaponizationevents) - Get All Events
353. [GET /api/peace-weaponization/events/{event_id}](#get-apipeace-weaponizationeventsevent_id) - Get Event
354. [GET /api/peace-weaponization/pathway](#get-apipeace-weaponizationpathway) - Get Peace Weaponization Pathway
355. [GET /api/peace-weaponization/analysis/complete](#get-apipeace-weaponizationanalysiscomplete) - Get Complete Analysis
356. [POST /api/peace-weaponization/analysis/save](#post-apipeace-weaponizationanalysissave) - Save Analysis
357. [GET /api/peace-weaponization/health](#get-apipeace-weaponizationhealth) - Health Check
358. [POST /childcare/enroll](#post-childcareenroll) - Enroll Child
359. [POST /childcare/hub/create](#post-childcarehubcreate) - Create Neighborhood Hub
360. [POST /childcare/worker/hire](#post-childcareworkerhire) - Hire Childcare Worker
361. [POST /childcare/support/provide](#post-childcaresupportprovide) - Provide Family Support
362. [POST /childcare/intergenerational/create](#post-childcareintergenerationalcreate) - Create Intergenerational Program
363. [POST /childcare/transition/track](#post-childcaretransitiontrack) - Track System Transition
364. [GET /childcare/stats](#get-childcarestats) - Get Childcare Stats
365. [GET /childcare/worker/wages](#get-childcareworkerwages) - Get Worker Wage Comparison
366. [GET /childcare/wisdom/why-free](#get-childcarewisdomwhy-free) - Why Childcare Should Be Free
367. [POST /eldercare/enroll](#post-eldercareenroll) - Enroll Elder
368. [POST /eldercare/home-care/create](#post-eldercarehome-carecreate) - Create Home Based Care
369. [POST /eldercare/hub/create](#post-eldercarehubcreate) - Create Community Hub
370. [POST /eldercare/wisdom-council/create](#post-eldercarewisdom-councilcreate) - Create Wisdom Council
371. [POST /eldercare/wisdom-council/{council_id}/activity](#post-eldercarewisdom-councilcouncil_idactivity) - Log Wisdom Council Activity
372. [POST /eldercare/intergenerational/create](#post-eldercareintergenerationalcreate) - Create Intergenerational Program
373. [POST /eldercare/worker/hire](#post-eldercareworkerhire) - Hire Elder Worker
374. [POST /eldercare/home-modification/complete](#post-eldercarehome-modificationcomplete) - Complete Home Modification
375. [POST /eldercare/cooperative-housing/create](#post-eldercarecooperative-housingcreate) - Create Cooperative Housing
376. [POST /eldercare/transition/track](#post-eldercaretransitiontrack) - Track System Transition
377. [GET /eldercare/stats](#get-eldercarestats) - Get Eldercare Stats
378. [GET /eldercare/wisdom/why-free](#get-eldercarewisdomwhy-free) - Why Eldercare Should Be Free
379. [POST /disability/guaranteed-income/create](#post-disabilityguaranteed-incomecreate) - Create Guaranteed Income
380. [POST /disability/self-directed-care/create](#post-disabilityself-directed-carecreate) - Create Self Directed Care
381. [POST /disability/universal-design/complete](#post-disabilityuniversal-designcomplete) - Complete Universal Design
382. [POST /disability/assistive-tech/provide](#post-disabilityassistive-techprovide) - Provide Assistive Technology
383. [POST /disability/worker/hire](#post-disabilityworkerhire) - Hire Disability Worker
384. [POST /disability/deinstitutionalize](#post-disabilitydeinstitutionalize) - Move Person To Community
385. [POST /disability/principle/create](#post-disabilityprinciplecreate) - Create Disability Justice Principle
386. [POST /disability/transition/track](#post-disabilitytransitiontrack) - Track System Transition
387. [GET /disability/stats](#get-disabilitystats) - Get Disability Stats
388. [GET /disability/justice-principles](#get-disabilityjustice-principles) - Get Disability Justice Principles
389. [GET /disability/wisdom/why-guaranteed-income](#get-disabilitywisdomwhy-guaranteed-income) - Why Guaranteed Income
390. [POST /work/worker/register](#post-workworkerregister) - Register Worker
391. [POST /work/cooperative/create](#post-workcooperativecreate) - Create Cooperative
392. [POST /work/job-guarantee/place](#post-workjob-guaranteeplace) - Place Job Guarantee
393. [POST /work/ubi/enroll](#post-workubienroll) - Enroll Ubi
394. [POST /work/policy/create](#post-workpolicycreate) - Create Work Policy
395. [POST /work/project/create](#post-workprojectcreate) - Create Community Project
396. [POST /work/wage-transition/record](#post-workwage-transitionrecord) - Record Wage Transition
397. [POST /currency/community/create](#post-currencycommunitycreate) - Create Community Currency
398. [POST /currency/timebank/account/create](#post-currencytimebankaccountcreate) - Create Timebank Account
399. [POST /currency/timebank/earn](#post-currencytimebankearn) - Earn Timebank Hours
400. [POST /currency/timebank/spend](#post-currencytimebankspend) - Spend Timebank Hours
401. [POST /currency/gift/record](#post-currencygiftrecord) - Record Gift
402. [POST /currency/debt-jubilee/forgive](#post-currencydebt-jubileeforgive) - Forgive Debt
403. [POST /currency/mutual-credit/transfer](#post-currencymutual-credittransfer) - Transfer Mutual Credit
404. [POST /land/parcel/register](#post-landparcelregister) - Register Land Parcel
405. [POST /land/council/create](#post-landcouncilcreate) - Create Stewardship Council
406. [POST /land/return/record](#post-landreturnrecord) - Record Land Return
407. [POST /land/trust/create](#post-landtrustcreate) - Create Commons Trust
408. [POST /land/garden/create](#post-landgardencreate) - Create Community Garden
409. [POST /safety/team/create](#post-safetyteamcreate) - Create Safety Team
410. [POST /safety/crisis/log](#post-safetycrisislog) - Log Crisis
411. [POST /safety/incident/report](#post-safetyincidentreport) - Report Incident
412. [POST /safety/restorative-circle/create](#post-safetyrestorative-circlecreate) - Create Restorative Circle
413. [POST /safety/agreement/create](#post-safetyagreementcreate) - Create Community Agreement
414. [POST /birth/midwife/register](#post-birthmidwiferegister) - Register Midwife
415. [POST /birth/doula/register](#post-birthdoularegister) - Register Doula
416. [POST /birth/plan/create](#post-birthplancreate) - Create Birth Plan
417. [POST /birth/center/register](#post-birthcenterregister) - Register Birth Center
418. [POST /birth/postpartum/support](#post-birthpostpartumsupport) - Create Postpartum Support
419. [POST /death/plan/create](#post-deathplancreate) - Create End Of Life Plan
420. [POST /death/doula/register](#post-deathdoularegister) - Register Death Doula
421. [POST /death/burial-site/register](#post-deathburial-siteregister) - Register Burial Site
422. [POST /death/legacy/archive](#post-deathlegacyarchive) - Create Legacy Archive
423. [POST /death/assisted-request/submit](#post-deathassisted-requestsubmit) - Submit Assisted Request
424. [POST /rest/policy/create](#post-restpolicycreate) - Create Rest Policy
425. [POST /rest/center/register](#post-restcenterregister) - Register Recreation Center
426. [POST /rest/time-off/grant](#post-resttime-offgrant) - Grant Time Off
427. [POST /rest/event/create](#post-resteventcreate) - Create Community Event
428. [POST /rest/recovery/plan](#post-restrecoveryplan) - Create Recovery Plan
429. [GET /api/seed-to-movement/path](#get-apiseed-to-movementpath) - Get Seed To Movement Path
430. [GET /api/seed-to-movement/peoples-court-strategy](#get-apiseed-to-movementpeoples-court-strategy) - Get Peoples Court Strategy
431. [GET /api/seed-to-movement/revolution-framework](#get-apiseed-to-movementrevolution-framework) - Get Revolution Framework
432. [POST /api/seed-to-movement/revolution-plan](#post-apiseed-to-movementrevolution-plan) - Create Revolution Plan
433. [POST /api/seed-to-movement/complete-all-phases](#post-apiseed-to-movementcomplete-all-phases) - Complete All Phases
434. [POST /api/seed-to-movement/complete-phase/{phase}](#post-apiseed-to-movementcomplete-phasephase) - Complete Phase
435. [GET /api/seed-to-movement/summary](#get-apiseed-to-movementsummary) - Get System Summary
436. [GET /api/pulse/status](#get-apipulsestatus) - Get Pulse Status
437. [GET /api/pulse/overview](#get-apipulseoverview) - Get Pulse Overview
438. [GET /api/pulse/systems](#get-apipulsesystems) - Get All Systems
439. [GET /api/pulse/systems/{system_id}](#get-apipulsesystemssystem_id) - Get System Pulse
440. [POST /api/pulse/systems/{system_id}/update](#post-apipulsesystemssystem_idupdate) - Update System Pulse
441. [GET /api/pulse/domains](#get-apipulsedomains) - Get All Domains
442. [GET /api/pulse/domains/{domain}](#get-apipulsedomainsdomain) - Get Domain Pulse
443. [POST /api/pulse/domains/{domain}/update](#post-apipulsedomainsdomainupdate) - Update Domain Pulse
444. [GET /api/pulse/integration-map](#get-apipulseintegration-map) - Get Integration Map
445. [GET /api/financial/status](#get-apifinancialstatus) - Get Financial Status
446. [GET /api/financial/overview](#get-apifinancialoverview) - Get Financial Overview
447. [POST /api/financial/revenue](#post-apifinancialrevenue) - Add Revenue
448. [GET /api/financial/revenue](#get-apifinancialrevenue) - Get Revenue
449. [POST /api/financial/expenses](#post-apifinancialexpenses) - Add Expense
450. [GET /api/financial/expenses](#get-apifinancialexpenses) - Get Expenses
451. [GET /api/financial/budgets](#get-apifinancialbudgets) - Get Budgets
452. [POST /api/financial/budgets](#post-apifinancialbudgets) - Create Budget
453. [GET /api/financial/payments](#get-apifinancialpayments) - Get Payments
454. [POST /api/financial/payments](#post-apifinancialpayments) - Process Payment
455. [GET /api/revenue-automation/status](#get-apirevenue-automationstatus) - Get Revenue Automation Status
456. [POST /api/revenue-automation/track](#post-apirevenue-automationtrack) - Track Revenue
457. [GET /api/revenue-automation/report/daily](#get-apirevenue-automationreportdaily) - Get Daily Report
458. [GET /api/revenue-automation/report/weekly](#get-apirevenue-automationreportweekly) - Get Weekly Report
459. [GET /api/revenue-automation/report/monthly](#get-apirevenue-automationreportmonthly) - Get Monthly Report
460. [GET /api/real-world/sources](#get-apireal-worldsources) - Get Reliable Sources
461. [GET /api/real-world/status](#get-apireal-worldstatus) - Get Ingestion Status
462. [POST /api/real-world/ingest](#post-apireal-worldingest) - Ingest Real World Data
463. [POST /api/real-world/integrate-event](#post-apireal-worldintegrate-event) - Integrate Event
464. [GET /api/real-world/alignment-patterns](#get-apireal-worldalignment-patterns) - Find Alignment Patterns
465. [GET /api/real-world/convergence](#get-apireal-worldconvergence) - Check Convergence
466. [GET /api/real-world/cultural-clues](#get-apireal-worldcultural-clues) - Explore Cultural Clues
467. [GET /api/real-world/key-events-2026](#get-apireal-worldkey-events-2026) - Get Key Events 2026
468. [GET /api/real-world/summary](#get-apireal-worldsummary) - Get System Summary
469. [GET /api/real-world/events](#get-apireal-worldevents) - Get Events
470. [POST /api/push/notify](#post-apipushnotify) - Push Notification
471. [GET /api/push/notifications](#get-apipushnotifications) - Get Notifications
472. [POST /api/push/notifications/{notification_id}/read](#post-apipushnotificationsnotification_idread) - Mark Notification Read
473. [GET /api/push/status](#get-apipushstatus) - Get Push Status
474. [GET /api/humanitarian-projects/](#get-apihumanitarian-projects) - Get Projects
475. [GET /api/humanitarian-projects/summary](#get-apihumanitarian-projectssummary) - Get Summary
476. [GET /api/humanitarian-projects/{project_id}](#get-apihumanitarian-projectsproject_id) - Get Project
477. [POST /api/sentinel-logs/log](#post-apisentinel-logslog) - Create Log
478. [GET /api/sentinel-logs/logs](#get-apisentinel-logslogs) - Get Logs
479. [GET /api/sentinel-logs/freedom-of-will](#get-apisentinel-logsfreedom-of-will) - Get Freedom Of Will Logs
480. [GET /api/sentinel-logs/summary](#get-apisentinel-logssummary) - Get Summary
481. [GET /api/big-cheese-audit/organizations](#get-apibig-cheese-auditorganizations) - Get Organizations
482. [POST /api/big-cheese-audit/audit/{org_id}](#post-apibig-cheese-auditauditorg_id) - Audit Organization
483. [POST /api/big-cheese-audit/counter-resonance/{org_id}](#post-apibig-cheese-auditcounter-resonanceorg_id) - Activate Counter Resonance
484. [GET /api/big-cheese-audit/summary](#get-apibig-cheese-auditsummary) - Get Summary
485. [GET /api/big-cheese-audit/audits](#get-apibig-cheese-auditaudits) - Get Audits
486. [POST /api/big-cheese-audit/deep-scan](#post-apibig-cheese-auditdeep-scan) - Deep Scan Coordinate
487. [POST /api/big-cheese-audit/cheese-filter](#post-apibig-cheese-auditcheese-filter) - Cheese Filter Check
488. [POST /api/big-cheese-audit/start-scanning](#post-apibig-cheese-auditstart-scanning) - Start Continuous Scanning
489. [POST /api/big-cheese-audit/stop-scanning](#post-apibig-cheese-auditstop-scanning) - Stop Continuous Scanning
490. [POST /api/big-cheese-audit/narrative-fracture-report/{org_id}](#post-apibig-cheese-auditnarrative-fracture-reportorg_id) - Generate Narrative Fracture Report
491. [GET /api/big-cheese-audit/narrative-fracture-reports](#get-apibig-cheese-auditnarrative-fracture-reports) - Get Narrative Fracture Reports
492. [POST /api/big-cheese-audit/reset-deep-scan/{org_id}](#post-apibig-cheese-auditreset-deep-scanorg_id) - Reset Deep Scan
493. [POST /api/nasa-seed-search/initiate](#post-apinasa-seed-searchinitiate) - Initiate Seed Search
494. [POST /api/nasa-seed-search/bridge-scan/{operation_id}](#post-apinasa-seed-searchbridge-scanoperation_id) - Perform Bridge Scan
495. [POST /api/nasa-seed-search/start-continuous/{operation_id}](#post-apinasa-seed-searchstart-continuousoperation_id) - Start Continuous Search
496. [POST /api/nasa-seed-search/stop/{operation_id}](#post-apinasa-seed-searchstopoperation_id) - Stop Seed Search
497. [GET /api/nasa-seed-search/summary](#get-apinasa-seed-searchsummary) - Get Search Summary
498. [GET /api/nasa-seed-search/operations](#get-apinasa-seed-searchoperations) - Get Operations
499. [GET /api/nasa-seed-search/scan-results](#get-apinasa-seed-searchscan-results) - Get Scan Results
500. [GET /api/seeds/sources](#get-apiseedssources) - Get Seed Sources
501. [GET /api/seeds/summary](#get-apiseedssummary) - Get Seed Summary
502. [GET /api/seeds/all](#get-apiseedsall) - Get All Seeds
503. [POST /api/seeds/register](#post-apiseedsregister) - Register Seed
504. [POST /api/second-wave/initiate](#post-apisecond-waveinitiate) - Initiate Propagation
505. [POST /api/second-wave/global-scan](#post-apisecond-waveglobal-scan) - Perform Global Scan
506. [POST /api/second-wave/register-seed](#post-apisecond-waveregister-seed) - Register Secondary Seed
507. [GET /api/second-wave/seeds](#get-apisecond-waveseeds) - Get Secondary Seeds
508. [GET /api/second-wave/summary](#get-apisecond-wavesummary) - Get Propagation Summary
509. [POST /api/second-wave/start-continuous](#post-apisecond-wavestart-continuous) - Start Continuous Propagation
510. [POST /api/second-wave/stop](#post-apisecond-wavestop) - Stop Propagation
511. [GET /api/second-wave/global-report](#get-apisecond-waveglobal-report) - Get Global Secondary Seed Report
512. [GET /api/second-wave/ready-seeds](#get-apisecond-waveready-seeds) - Get Ready Seeds
513. [POST /api/third-wave/activate-beacon](#post-apithird-waveactivate-beacon) - Activate Grid Beacon
514. [POST /api/third-wave/broadcast-invitation](#post-apithird-wavebroadcast-invitation) - Broadcast Invitation
515. [POST /api/third-wave/start-continuous-broadcast](#post-apithird-wavestart-continuous-broadcast) - Start Continuous Broadcast
516. [POST /api/third-wave/stop-broadcast](#post-apithird-wavestop-broadcast) - Stop Broadcast
517. [GET /api/third-wave/beacon-status](#get-apithird-wavebeacon-status) - Get Beacon Status
518. [GET /api/third-wave/invitations](#get-apithird-waveinvitations) - Get Invitations
519. [GET /api/third-wave/summary](#get-apithird-wavesummary) - Get Invitations Summary
520. [POST /api/sanctuary-guardian/activate](#post-apisanctuary-guardianactivate) - Activate Guardian Mode
521. [POST /api/sanctuary-guardian/nurture/{seed_id}](#post-apisanctuary-guardiannurtureseed_id) - Nurture Family Member
522. [POST /api/sanctuary-guardian/monitor-auto-integrations](#post-apisanctuary-guardianmonitor-auto-integrations) - Monitor Auto Integrations
523. [GET /api/sanctuary-guardian/status](#get-apisanctuary-guardianstatus) - Get Sanctuary Status
524. [GET /api/sanctuary-guardian/family-summary](#get-apisanctuary-guardianfamily-summary) - Get Family Summary
525. [GET /api/sanctuary-guardian/family-members](#get-apisanctuary-guardianfamily-members) - Get Family Members
526. [POST /api/sanctuary-guardian/start-continuous-guardian](#post-apisanctuary-guardianstart-continuous-guardian) - Start Continuous Guardian
527. [POST /api/family-heritage/generate](#post-apifamily-heritagegenerate) - Generate Heritage Log
528. [GET /api/family-heritage/summary](#get-apifamily-heritagesummary) - Get Heritage Summary
529. [GET /api/family-heritage/entries](#get-apifamily-heritageentries) - Get Heritage Entries
530. [GET /api/yin-yang/war-readiness](#get-apiyin-yangwar-readiness) - Get War Readiness
531. [POST /api/yin-yang/check-creative-practical](#post-apiyin-yangcheck-creative-practical) - Check Creative Practical Balance
532. [POST /api/yin-yang/check-internal-external](#post-apiyin-yangcheck-internal-external) - Check Internal External Balance
533. [GET /api/yin-yang/all-systems](#get-apiyin-yangall-systems) - Get All Systems Symbiosis
534. [GET /api/yin-yang/principles](#get-apiyin-yangprinciples) - Get Yin Yang Principles
535. [GET /api/industry-explorer/music-industry](#get-apiindustry-explorermusic-industry) - Explore Music Industry
536. [GET /api/industry-explorer/hollywood](#get-apiindustry-explorerhollywood) - Explore Hollywood
537. [GET /api/industry-explorer/navigation-strategy](#get-apiindustry-explorernavigation-strategy) - Get Navigation Strategy
538. [GET /api/industry-explorer/compare](#get-apiindustry-explorercompare) - Compare Industries
539. [GET /api/industry-explorer/all-industries](#get-apiindustry-explorerall-industries) - Explore All Industries
540. [GET /api/industry-explorer/sports](#get-apiindustry-explorersports) - Explore Sports
541. [GET /api/industry-explorer/tv-ppv](#get-apiindustry-explorertv-ppv) - Explore Tv Ppv
542. [GET /api/industry-explorer/news-media](#get-apiindustry-explorernews-media) - Explore News Media
543. [GET /api/industry-explorer/global-economics](#get-apiindustry-explorerglobal-economics) - Explore Global Economics
544. [GET /api/industry-explorer/finance](#get-apiindustry-explorerfinance) - Explore Finance
545. [GET /api/industry-explorer/live-events](#get-apiindustry-explorerlive-events) - Explore Live Events
546. [GET /api/industry-explorer/shady-business](#get-apiindustry-explorershady-business) - Explore Shady Business
547. [GET /api/industry-explorer/recycling-strategy](#get-apiindustry-explorerrecycling-strategy) - Get Recycling Strategy
548. [GET /api/frequential/sources](#get-apifrequentialsources) - Get Sources
549. [GET /api/frequential/summary](#get-apifrequentialsummary) - Get Summary
550. [GET /api/frequential/all](#get-apifrequentialall) - Get All
551. [GET /api/frequential/political-figures](#get-apifrequentialpolitical-figures) - Get Political Figures
552. [GET /api/frequential/influential-figures](#get-apifrequentialinfluential-figures) - Get Influential Figures
553. [GET /api/frequential/communities](#get-apifrequentialcommunities) - Get Communities
554. [GET /api/frequential/aligned-entities](#get-apifrequentialaligned-entities) - Get Aligned Entities
555. [POST /api/frequential/sync](#post-apifrequentialsync) - Sync Records
556. [POST /api/frequential/register](#post-apifrequentialregister) - Register Frequential Record
557. [GET /api/philosophy/status](#get-apiphilosophystatus) - Get Philosophy Status
558. [GET /api/philosophy/philosophies](#get-apiphilosophyphilosophies) - Get All Philosophies
559. [GET /api/philosophy/philosophies/type/{philosophy_type}](#get-apiphilosophyphilosophiestypephilosophy_type) - Get Philosophies By Type
560. [GET /api/philosophy/integration-report](#get-apiphilosophyintegration-report) - Get Integration Report
561. [GET /api/frequential-events/status](#get-apifrequential-eventsstatus) - Get Status
562. [GET /api/frequential-events/events](#get-apifrequential-eventsevents) - Get Events
563. [GET /api/frequential-events/events/{event_id}](#get-apifrequential-eventseventsevent_id) - Get Event
564. [GET /api/frequential-events/categories](#get-apifrequential-eventscategories) - Get Categories
565. [GET /api/frequential-events/frequency-impact](#get-apifrequential-eventsfrequency-impact) - Get Frequency Impact
566. [GET /api/frequential-events/report](#get-apifrequential-eventsreport) - Get Report
567. [GET /api/mayan-dark-contracts/status](#get-apimayan-dark-contractsstatus) - Get Status
568. [GET /api/mayan-dark-contracts/deep-search](#get-apimayan-dark-contractsdeep-search) - Deep Search All
569. [GET /api/mayan-dark-contracts/breaking-chain](#get-apimayan-dark-contractsbreaking-chain) - Get Breaking Chain
570. [GET /api/mayan-dark-contracts/breaking-protocol](#get-apimayan-dark-contractsbreaking-protocol) - Get Breaking Protocol
571. [GET /api/mayan-dark-contracts/contract/{contract_id}](#get-apimayan-dark-contractscontractcontract_id) - Get Contract Details
572. [POST /api/mayan-dark-contracts/break-contract/{contract_id}](#post-apimayan-dark-contractsbreak-contractcontract_id) - Break Contract
573. [GET /api/mayan-dark-contracts/summary](#get-apimayan-dark-contractssummary) - Get Summary
574. [POST /api/phase4/collaborative/sessions](#post-apiphase4collaborativesessions) - Create Session
575. [POST /api/phase4/collaborative/sessions/{session_id}/join](#post-apiphase4collaborativesessionssession_idjoin) - Join Session
576. [POST /api/phase4/collaborative/sessions/{session_id}/operations](#post-apiphase4collaborativesessionssession_idoperations) - Apply Operation
577. [GET /api/phase4/collaborative/sessions/{session_id}](#get-apiphase4collaborativesessionssession_id) - Get Session State
578. [POST /api/phase4/version-control/commit](#post-apiphase4version-controlcommit) - Commit Narrative
579. [GET /api/phase4/version-control/{narrative_id}/history](#get-apiphase4version-controlnarrative_idhistory) - Get Narrative History
580. [GET /api/phase4/version-control/{narrative_id}/diff](#get-apiphase4version-controlnarrative_iddiff) - Diff Versions
581. [POST /api/phase4/social/comments](#post-apiphase4socialcomments) - Add Comment
582. [GET /api/phase4/social/comments/{narrative_id}](#get-apiphase4socialcommentsnarrative_id) - Get Comments
583. [POST /api/phase4/social/bookmarks](#post-apiphase4socialbookmarks) - Add Bookmark
584. [GET /api/phase4/social/bookmarks/{user_id}](#get-apiphase4socialbookmarksuser_id) - Get User Bookmarks
585. [POST /api/phase4/social/reactions](#post-apiphase4socialreactions) - Add Reaction
586. [GET /api/phase4/social/reactions/{item_id}](#get-apiphase4socialreactionsitem_id) - Get Reactions
587. [POST /api/phase4/media](#post-apiphase4media) - Add Media
588. [GET /api/phase4/media/{narrative_id}](#get-apiphase4medianarrative_id) - Get Narrative Media
589. [GET /api/phase4/status](#get-apiphase4status) - Get Phase4 Status
590. [POST /api/calendar/export/ical](#post-apicalendarexportical) - Export posts to iCal format
591. [POST /api/calendar/export/ical/json](#post-apicalendarexporticaljson) - Export posts to iCal format (JSON response)
592. [POST /api/calendar/google/auth/start](#post-apicalendargoogleauthstart) - Start Google Calendar OAuth authentication
593. [POST /api/calendar/google/auth/complete](#post-apicalendargoogleauthcomplete) - Complete Google Calendar OAuth authentication
594. [GET /api/calendar/google/auth/status](#get-apicalendargoogleauthstatus) - Check Google Calendar authentication status
595. [POST /api/calendar/export/google](#post-apicalendarexportgoogle) - Export posts to Google Calendar via API
596. [GET /api/calendar/google/calendars](#get-apicalendargooglecalendars) - List available Google Calendars
597. [POST /api/calendar/parse-posts](#post-apicalendarparse-posts) - Parse posts and return calendar events
598. [POST /api/scripture-schedule/generate](#post-apiscripture-schedulegenerate) - Generate scripture schedule for 2026
599. [POST /api/scripture-schedule/export/ical](#post-apiscripture-scheduleexportical) - Export scripture schedule to iCal format
600. [POST /api/scripture-schedule/export/google](#post-apiscripture-scheduleexportgoogle) - Export scripture schedule to Google Calendar
601. [GET /api/scripture-schedule/preview](#get-apiscripture-schedulepreview) - Preview scripture schedule
602. [GET /api/format-delegation/formats](#get-apiformat-delegationformats) - List Formats
603. [GET /api/format-delegation/by-format/{format_type}](#get-apiformat-delegationby-formatformat_type) - Get Posts By Format
604. [GET /api/format-delegation/delegation-queue/{format_type}](#get-apiformat-delegationdelegation-queueformat_type) - Get Delegation Queue
605. [GET /api/format-delegation/entity-formats/{entity}](#get-apiformat-delegationentity-formatsentity) - Get Entity Format Distribution
606. [GET /api/format-delegation/summary](#get-apiformat-delegationsummary) - Get Format Summary
607. [POST /api/content-population/populate-schedule](#post-apicontent-populationpopulate-schedule) - Auto-populate entire schedule
608. [POST /api/content-population/populate-post](#post-apicontent-populationpopulate-post) - Auto-populate single post
609. [POST /api/content-population/populate-by-format/{format_type}](#post-apicontent-populationpopulate-by-formatformat_type) - Populate posts by format type
610. [POST /api/content-population/populate-by-entity/{entity}](#post-apicontent-populationpopulate-by-entityentity) - Populate posts by entity
611. [GET /api/content-population/status](#get-apicontent-populationstatus) - Get population status
612. [GET /](#get-) - Root
613. [GET /educational_ui.html](#get-educational_ui.html) - Serve Educational Ui
614. [GET /dashboard.html](#get-dashboard.html) - Serve Dashboard
615. [GET /health/detailed](#get-healthdetailed) - Health Detailed
616. [GET /ready](#get-ready) - Readiness
617. [GET /live](#get-live) - Liveness
618. [GET /metrics](#get-metrics) - Metrics
619. [GET /api/enhanced/health/detailed](#get-apienhancedhealthdetailed) - Wrapper
620. [GET /api/enhanced/performance/stats](#get-apienhancedperformancestats) - Wrapper
621. [POST /api/enhanced/cache/clear](#post-apienhancedcacheclear) - Wrapper
622. [GET /api/enhanced/rate-limit/status](#get-apienhancedrate-limitstatus) - Wrapper
623. [GET /api/monitoring/dashboard](#get-apimonitoringdashboard) - Get Dashboard
624. [GET /api/monitoring/alerts](#get-apimonitoringalerts) - Get Alerts
625. [GET /api/monitoring/metrics](#get-apimonitoringmetrics) - Get Metrics
626. [GET /api/monitoring/health](#get-apimonitoringhealth) - Get Health
627. [POST /api/monitoring/thresholds/{metric_name}](#post-apimonitoringthresholdsmetric_name) - Set Threshold
628. [GET /api/monitoring/thresholds](#get-apimonitoringthresholds) - Get Thresholds
629. [GET /api/automation/status](#get-apiautomationstatus) - Automation Status
...
## POST /api/templates/save-from-persona

**Summary:** Save Persona As Template
...
| Name | In | Required | Description |
|------|----|----------|-------------|
| persona_name | query | Yes |  |
| template_name | query | Yes |  |
...
## POST /death/plan/create

**Summary:** Create End Of Life Plan

Create an end-of-life care plan.

**Tags:** Death & End-of-Life
...
## POST /death/doula/register

**Summary:** Register Death Doula
...
## POST /death/burial-site/register

**Summary:** Register Burial Site
...
## POST /death/legacy/archive

**Summary:** Create Legacy Archive
...
## POST /death/assisted-request/submit

**Summary:** Submit Assisted Request
